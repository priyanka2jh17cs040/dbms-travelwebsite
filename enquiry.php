...
<tr><td class="lefttxt">Gender:</td><td><input type="text" name="t9" value="Male" checked="checked" />Male<input type="text" name="t8"  value="Female"/>Female</td></tr><br/>
...
<tr><td class="lefttxt">which place:</td><td><textarea name="t7" required="required"/></textarea></td><td><br/>
